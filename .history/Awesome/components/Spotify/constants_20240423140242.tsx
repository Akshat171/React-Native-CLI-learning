...
export const playListData: Track[] = [
  {
    ...
    url: require('./assets/songs/one.mp3'),
  },
  {
    id: 2,
    ...
    url: require('./assets/songs/two.mp3'),
  },
  {
    id: 3,
    title: 'Kesariya',
    ...
    url: require('./assets/songs/three.mp3'),
  },
  {
    id: 4,
    title: 'Title Track',
    ...
    url: require('./assets/songs/four.mp3'),
  },
  {
    id: 5,
    title: 'Besharam Rang',
    ...
    url: require('./assets/songs/five.mp3'),
  },
];
